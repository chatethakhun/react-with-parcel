...
function (_React$Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "increase", function () {
      _this.setState({
  ...
  _createClass(App, [{
    ...
    value: function render() {
      // console.log(Example);
      return _react.default.createElement("div", null, "app component state count ", this.state.count, " ", _react.default.createElement("button", {
...
(0, _reactDom.render)(_react.default.createElement(_app.default, null), document.getElementById("react-app"));
